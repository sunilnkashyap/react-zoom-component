...
const ZoomComponent = (props) => {
    ...
    return (react_1.default.createElement("div", { style: { position: 'relative' } },
        react_1.default.createElement("div", { ref: zoomLens, onMouseMove: moveCursor, style: zoomLensStyle }),
        react_1.default.createElement("img", { ref: imgRef, onMouseMove: moveCursor, alt: props.ImageAlt || 'Image', src: props.Image, width: props.Width, height: props.Height }),
        react_1.default.createElement("div", { ref: resultRef, style: resultDivStyle })));
};
